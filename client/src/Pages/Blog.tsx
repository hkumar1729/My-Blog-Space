...
export default function Blog(){
    ...
    return<>
        ...
        <div className="p-10 mt-10">
            ...
            <textarea id="message" rows={10} onChange={(e)=>{setContent((c:blogParam)=>({...c, content:e.target.value}))}} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your blog post here..."></textarea>
